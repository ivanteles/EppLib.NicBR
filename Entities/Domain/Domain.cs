...
namespace EppLib.Entities.Domain
{
    public class Domain
    {
        ...
        /// <summary>
        ///     The authorization code associated with the domain name. This is only returned if the queriying registrar is the
        ///     sponsoring registrar and the registrar has provided valid authorization with the request
        /// </summary>
